...
class Checkbar(Frame):
   def __init__(self, parent=None, picks=[], side=LEFT, anchor=W):
      ...
      for pick in picks:
         var = IntVar()
         chk = Checkbutton(self, text=pick, font= "Arial 8", variable=var, bd=2)
...
def Desayunos():   
    ...
    def allstates(): 
        ...
        Desayunos7(IngredientesDFinales,ventana)
...
def Almuerzos():
    ...
    def allstates():
        ...
        Almuerzos7(IngredientesAFinales, ventana)
...
def Comidas():
    ...
    def allstates(): 
        ...
        print(IngredientesCFinales)
        Cenas7(IngredientesCFinales, ventana)
...
def Postres():
    ...
    def allstates(): 
        ...
        print(IngredientesPFinales)
        Postres7(IngredientesPFinales, ventana)
